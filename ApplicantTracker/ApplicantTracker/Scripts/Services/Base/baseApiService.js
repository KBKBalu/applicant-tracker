...
(function (angular) {
    ...
    angular.module('sbAdminApp').service('baseApiService',
        ['$http', '$q', '$location', function ($http, $q, $location) {

            var _baseUrl = 'api';
            var _pathSeparator = '/';
            var _resource = 'Apptrack';           
            ...
            function loadTemplate(resource) {
                ...
                return $location.absUrl().indexOf('/ApplicantTracker') > -1 ? 'ApplicantTracker/' + resource : resource;
